...
describe('apiCalls', () => {
        ...
        mockData = {
          results: [
            ...
            },
            {
              ...
              vote_average: 8,
              overview:
                'An overly romanticized version of American Reconstruction',
              PIZZA: 'TACOS'
            }
          ],
          total_pages: 20,
  ...
  describe('fetchAllFavorites', () => {
    beforeAll(() => {
      window.fetch = jest.fn().mockImplementation(() =>
        Promise.resolve({
          ...
          json: () =>
            Promise.resolve({
              data: [{ title: 'Bravheart' }, { title: 'Trolls' }]
            })
        })
      );
    });
    ...
    it('should return an array of favorited movie objects', () => {
      const mockUserId = 3;
      const expected = [{ title: 'Bravheart' }, { title: 'Trolls' }];
